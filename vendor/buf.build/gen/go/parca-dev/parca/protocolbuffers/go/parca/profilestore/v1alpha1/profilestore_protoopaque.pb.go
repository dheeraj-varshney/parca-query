...
type WriteRawRequest struct {
	...
	xxx_hidden_Series     *[]*RawProfileSeries   `protobuf:"bytes,2,rep,name=series,proto3"`
	xxx_hidden_Normalized bool                   `protobuf:"varint,3,opt,name=normalized,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type RawProfileSeries struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Labels  *LabelSet              `protobuf:"bytes,1,opt,name=labels,proto3"`
	xxx_hidden_Samples *[]*RawSample          `protobuf:"bytes,2,rep,name=samples,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type RawSample struct {
	state                     protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_RawProfile     []byte                 `protobuf:"bytes,1,opt,name=raw_profile,json=rawProfile,proto3"`
	xxx_hidden_ExecutableInfo *[]*ExecutableInfo     `protobuf:"bytes,2,rep,name=executable_info,json=executableInfo,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
type ExecutableInfo struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ElfType     uint32                 `protobuf:"varint,1,opt,name=elf_type,json=elfType,proto3"`
	xxx_hidden_LoadSegment *LoadSegment           `protobuf:"bytes,2,opt,name=load_segment,json=loadSegment,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type LoadSegment struct {
	...
	xxx_hidden_Vaddr  uint64                 `protobuf:"varint,2,opt,name=vaddr,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type AgentsResponse struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Agents *[]*Agent              `protobuf:"bytes,1,rep,name=agents,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type Agent struct {
	...
	xxx_hidden_LastError        string                 `protobuf:"bytes,2,opt,name=last_error,json=lastError,proto3"`
	xxx_hidden_LastPush         *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=last_push,json=lastPush,proto3"`
	xxx_hidden_LastPushDuration *durationpb.Duration   `protobuf:"bytes,4,opt,name=last_push_duration,json=lastPushDuration,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}

...
func (b0 ProfileType_builder) Build() *ProfileType {
	...
	_, _ = b, x
	x.Name = b.Name
	x.SampleType = b.SampleType
	x.SampleUnit = b.SampleUnit
	x.PeriodType = b.PeriodType
	x.PeriodUnit = b.PeriodUnit
	x.Delta = b.Delta
	return m0
}
...
func (b0 MetricsSample_builder) Build() *MetricsSample {
	...
	x.Value = b.Value
	x.ValuePerSecond = b.ValuePerSecond
...
func (x *ProfileDiffSelection) SetMerge(v *MergeProfile) {
	...
	x.Options = &ProfileDiffSelection_Merge{v}
}
...
func (x *ProfileDiffSelection) SetSingle(v *SingleProfile) {
	...
	x.Options = &ProfileDiffSelection_Single{v}
}
...
func (x *ProfileDiffSelection) HasMerge() bool {
	...
	_, ok := x.Options.(*ProfileDiffSelection_Merge)
	return ok
}
...
func (x *ProfileDiffSelection) HasSingle() bool {
	...
	_, ok := x.Options.(*ProfileDiffSelection_Single)
	return ok
}
...
func (x *ProfileDiffSelection) ClearMerge() {
	if _, ok := x.Options.(*ProfileDiffSelection_Merge); ok {
		x.Options = nil
	}
}

func (x *ProfileDiffSelection) ClearSingle() {
	if _, ok := x.Options.(*ProfileDiffSelection_Single); ok {
		x.Options = nil
	}
}
...
func (b0 ProfileDiffSelection_builder) Build() *ProfileDiffSelection {
	...
	x.Mode = b.Mode
	if b.Merge != nil {
		x.Options = &ProfileDiffSelection_Merge{b.Merge}
	}
	if b.Single != nil {
		x.Options = &ProfileDiffSelection_Single{b.Single}
	}
	return m0
}
...
func (x *QueryRequest) SetMerge(v *MergeProfile) {
	...
	x.Options = &QueryRequest_Merge{v}
}
...
func (x *QueryRequest) SetSingle(v *SingleProfile) {
	...
	x.Options = &QueryRequest_Single{v}
}
...
func (x *QueryRequest) HasDiff() bool {
	...
	_, ok := x.Options.(*QueryRequest_Diff)
	return ok
}
...
func (x *QueryRequest) HasMerge() bool {
	...
	_, ok := x.Options.(*QueryRequest_Merge)
	return ok
}
...
func (x *QueryRequest) HasSingle() bool {
	...
	_, ok := x.Options.(*QueryRequest_Single)
	return ok
}
...
func (x *QueryRequest) HasNodeTrimThreshold() bool {
	...
	return x.NodeTrimThreshold != nil
}
...
func (x *QueryRequest) ClearDiff() {
	if _, ok := x.Options.(*QueryRequest_Diff); ok {
		x.Options = nil
	}
}

func (x *QueryRequest) ClearMerge() {
	if _, ok := x.Options.(*QueryRequest_Merge); ok {
		x.Options = nil
	}
}

func (x *QueryRequest) ClearSingle() {
	if _, ok := x.Options.(*QueryRequest_Single); ok {
		x.Options = nil
	}
}
...
func (b0 QueryRequest_builder) Build() *QueryRequest {
	...
	x.Mode = b.Mode
	if b.Diff != nil {
		x.Options = &QueryRequest_Diff{b.Diff}
	}
	if b.Merge != nil {
		x.Options = &QueryRequest_Merge{b.Merge}
	}
	if b.Single != nil {
		x.Options = &QueryRequest_Single{b.Single}
	}
	x.ReportType = b.ReportType
	x.FilterQuery = b.FilterQuery
	x.NodeTrimThreshold = b.NodeTrimThreshold
	x.GroupBy = b.GroupBy
	x.SourceReference = b.SourceReference
	x.RuntimeFilter = b.RuntimeFilter
	x.InvertCallStack = b.InvertCallStack
	x.Filter = b.Filter
	return m0
}
...
func (x *Filter) HasStackFilter() bool {
	...
	_, ok := x.Filter.(*Filter_StackFilter)
	return ok
}
...
func (x *Filter) HasFrameFilter() bool {
	...
	_, ok := x.Filter.(*Filter_FrameFilter)
	return ok
}
...
func (x *Filter) ClearStackFilter() {
	if _, ok := x.Filter.(*Filter_StackFilter); ok {
		x.Filter = nil
	}
}

func (x *Filter) ClearFrameFilter() {
	if _, ok := x.Filter.(*Filter_FrameFilter); ok {
		x.Filter = nil
	}
}
...
func (b0 Filter_builder) Build() *Filter {
	...
	if b.StackFilter != nil {
		x.Filter = &Filter_StackFilter{b.StackFilter}
	}
	if b.FrameFilter != nil {
		x.Filter = &Filter_FrameFilter{b.FrameFilter}
	}
	return m0
}
...
func (x *StackFilter) SetFunctionNameStackFilter(v *FunctionNameStackFilter) {
	...
	x.Filter = &StackFilter_FunctionNameStackFilter{v}
}
...
func (x *StackFilter) HasFunctionNameStackFilter() bool {
	...
	_, ok := x.Filter.(*StackFilter_FunctionNameStackFilter)
	return ok
}
...
func (x *StackFilter) ClearFunctionNameStackFilter() {
	if _, ok := x.Filter.(*StackFilter_FunctionNameStackFilter); ok {
		x.Filter = nil
	}
}
...
func (b0 StackFilter_builder) Build() *StackFilter {
	...
	if b.FunctionNameStackFilter != nil {
		x.Filter = &StackFilter_FunctionNameStackFilter{b.FunctionNameStackFilter}
	}
	return m0
}
...
func (b0 FunctionNameStackFilter_builder) Build() *FunctionNameStackFilter {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.FunctionToFilter = b.FunctionToFilter
	return m0
}
...
func (x *FrameFilter) SetBinaryFrameFilter(v *BinaryFrameFilter) {
	...
	x.Filter = &FrameFilter_BinaryFrameFilter{v}
}
...
func (x *FrameFilter) HasBinaryFrameFilter() bool {
	...
	_, ok := x.Filter.(*FrameFilter_BinaryFrameFilter)
	return ok
}
...
func (x *FrameFilter) ClearBinaryFrameFilter() {
	if _, ok := x.Filter.(*FrameFilter_BinaryFrameFilter); ok {
		x.Filter = nil
	}
}
...
func (b0 FrameFilter_builder) Build() *FrameFilter {
	...
	if b.BinaryFrameFilter != nil {
		x.Filter = &FrameFilter_BinaryFrameFilter{b.BinaryFrameFilter}
	}
	return m0
}
...
func (b0 BinaryFrameFilter_builder) Build() *BinaryFrameFilter {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.IncludeBinaries = b.IncludeBinaries
	return m0
}
...
func (b0 RuntimeFilter_builder) Build() *RuntimeFilter {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.ShowPython = b.ShowPython
	x.ShowRuby = b.ShowRuby
	x.ShowInterpretedOnly = b.ShowInterpretedOnly
	return m0
}
...
func (b0 Flamegraph_builder) Build() *Flamegraph {
	...
	x.Unit = b.Unit
	x.Height = b.Height
	x.StringTable = b.StringTable
	x.Locations = b.Locations
	x.Mapping = b.Mapping
	x.Function = b.Function
	x.UntrimmedTotal = b.UntrimmedTotal
	x.Trimmed = b.Trimmed
	return m0
}
...
func (b0 FlamegraphNodeMeta_builder) Build() *FlamegraphNodeMeta {
	...
	x.Function = b.Function
	x.Line = b.Line
	x.LocationIndex = b.LocationIndex
	x.LineIndex = b.LineIndex
	return m0
}
...
func (x *QueryResponse) SetFlamegraph(v *Flamegraph) {
	...
	x.Report = &QueryResponse_Flamegraph{v}
}
...
func (x *QueryResponse) SetPprof(v []byte) {
	...
	x.Report = &QueryResponse_Pprof{v}
}
...
func (x *QueryResponse) SetCallgraph(v *Callgraph) {
	...
	x.Report = &QueryResponse_Callgraph{v}
}
...
func (x *QueryResponse) SetFlamegraphArrow(v *FlamegraphArrow) {
	...
	x.Report = &QueryResponse_FlamegraphArrow{v}
}
...
func (x *QueryResponse) SetSource(v *Source) {
	...
	x.Report = &QueryResponse_Source{v}
}
...
func (x *QueryResponse) SetTableArrow(v *TableArrow) {
	...
	x.Report = &QueryResponse_TableArrow{v}
}
...
func (x *QueryResponse) SetProfileMetadata(v *ProfileMetadata) {
	...
	x.Report = &QueryResponse_ProfileMetadata{v}
}
...
func (x *QueryResponse) HasFlamegraph() bool {
	...
	_, ok := x.Report.(*QueryResponse_Flamegraph)
	return ok
}
...
func (x *QueryResponse) HasPprof() bool {
	...
	_, ok := x.Report.(*QueryResponse_Pprof)
	return ok
}
...
func (x *QueryResponse) HasTop() bool {
	...
	_, ok := x.Report.(*QueryResponse_Top)
	return ok
}
...
func (x *QueryResponse) HasCallgraph() bool {
	...
	_, ok := x.Report.(*QueryResponse_Callgraph)
	return ok
}
...
func (x *QueryResponse) HasFlamegraphArrow() bool {
	...
	_, ok := x.Report.(*QueryResponse_FlamegraphArrow)
	return ok
}
...
func (x *QueryResponse) HasSource() bool {
	...
	_, ok := x.Report.(*QueryResponse_Source)
	return ok
}
...
func (x *QueryResponse) HasTableArrow() bool {
	...
	_, ok := x.Report.(*QueryResponse_TableArrow)
	return ok
}
...
func (x *QueryResponse) HasProfileMetadata() bool {
	...
	_, ok := x.Report.(*QueryResponse_ProfileMetadata)
	return ok
}
...
func (x *QueryResponse) ClearFlamegraph() {
	if _, ok := x.Report.(*QueryResponse_Flamegraph); ok {
		x.Report = nil
	}
}

func (x *QueryResponse) ClearPprof() {
	if _, ok := x.Report.(*QueryResponse_Pprof); ok {
		x.Report = nil
	}
}

func (x *QueryResponse) ClearTop() {
	if _, ok := x.Report.(*QueryResponse_Top); ok {
		x.Report = nil
	}
}

func (x *QueryResponse) ClearCallgraph() {
	if _, ok := x.Report.(*QueryResponse_Callgraph); ok {
		x.Report = nil
	}
}

func (x *QueryResponse) ClearFlamegraphArrow() {
	if _, ok := x.Report.(*QueryResponse_FlamegraphArrow); ok {
		x.Report = nil
	}
}

func (x *QueryResponse) ClearSource() {
	if _, ok := x.Report.(*QueryResponse_Source); ok {
		x.Report = nil
	}
}

func (x *QueryResponse) ClearTableArrow() {
	if _, ok := x.Report.(*QueryResponse_TableArrow); ok {
		x.Report = nil
	}
}

func (x *QueryResponse) ClearProfileMetadata() {
	if _, ok := x.Report.(*QueryResponse_ProfileMetadata); ok {
		x.Report = nil
	}
}
...
func (b0 QueryResponse_builder) Build() *QueryResponse {
	...
	_, _ = b, x
	if b.Flamegraph != nil {
		x.Report = &QueryResponse_Flamegraph{b.Flamegraph}
	}
	if b.Pprof != nil {
		x.Report = &QueryResponse_Pprof{b.Pprof}
	}
	if b.Top != nil {
		x.Report = &QueryResponse_Top{b.Top}
	}
	if b.Callgraph != nil {
		x.Report = &QueryResponse_Callgraph{b.Callgraph}
	}
	if b.FlamegraphArrow != nil {
		x.Report = &QueryResponse_FlamegraphArrow{b.FlamegraphArrow}
	}
	if b.Source != nil {
		x.Report = &QueryResponse_Source{b.Source}
	}
	if b.TableArrow != nil {
		x.Report = &QueryResponse_TableArrow{b.TableArrow}
	}
	if b.ProfileMetadata != nil {
		x.Report = &QueryResponse_ProfileMetadata{b.ProfileMetadata}
	}
	x.Total = b.Total
	x.Filtered = b.Filtered
	return m0
}

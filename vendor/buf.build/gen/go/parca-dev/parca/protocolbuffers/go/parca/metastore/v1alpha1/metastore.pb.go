...
func (b0 StacktracesRequest_builder) Build() *StacktracesRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.StacktraceIds = b.StacktraceIds
	return m0
}
...
func (b0 Sample_builder) Build() *Sample {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.StacktraceId = b.StacktraceId
	x.Labels = b.Labels
	x.NumLabels = b.NumLabels
	x.NumUnits = b.NumUnits
	return m0
}
...
func (b0 Location_builder) Build() *Location {
	...
	x.Id = b.Id
	x.Address = b.Address
	x.MappingId = b.MappingId
	x.IsFolded = b.IsFolded
	x.Lines = b.Lines
	x.MappingIndex = b.MappingIndex
	return m0
}
...
func (b0 Line_builder) Build() *Line {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.FunctionId = b.FunctionId
	x.Line = b.Line
	x.FunctionIndex = b.FunctionIndex
	return m0
}
...
func (x *Function) SetSystemNameStringIndex(v uint32) {
	x.SystemNameStringIndex = v
}

func (x *Function) SetFilenameStringIndex(v uint32) {
	x.FilenameStringIndex = v
}
...
func (b0 Function_builder) Build() *Function {
	...
	x.Name = b.Name
	x.SystemName = b.SystemName
	x.Filename = b.Filename
	x.NameStringIndex = b.NameStringIndex
	x.SystemNameStringIndex = b.SystemNameStringIndex
	x.FilenameStringIndex = b.FilenameStringIndex
	return m0
}
...
func (b0 Mapping_builder) Build() *Mapping {
	...
	x.File = b.File
	x.BuildId = b.BuildId
	x.HasFunctions = b.HasFunctions
	x.HasFilenames = b.HasFilenames
	x.HasLineNumbers = b.HasLineNumbers
	x.HasInlineFrames = b.HasInlineFrames
	x.FileStringIndex = b.FileStringIndex
	x.BuildIdStringIndex = b.BuildIdStringIndex
	return m0
}
